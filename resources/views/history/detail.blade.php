        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h5>Pesanan Sudah di CheckOut Silahkan konfirmasi Dengan Admin Melalui <strong>Nomor WhatsApp : 085233175312</strong> Atau Klik Icon WhatsApp di Atas</h5>
                </div>
            </div>
            <div class="card mt-2">
                <div class="card-body">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td colspan="5" align="right"><strong>Kode Bayar :</strong></td>
